...
func Mail(to, otp string) error {
	...
	// From
	m.SetHeader("From", "Yuhuu <mail@yuhuu.site>")
	m.SetHeader("To", to)
	...
	body := fmt.Sprintf(`
		<div style="font-family: Arial, sans-serif; font-size: 16px; color: #333;">
			...
			<p>
				To keep your account secure, we recommend using a unique password for your Yuhuu account or using the Yuhuu Account Access app to sign in.
				Two-factor authentication makes signing in easier and safer — without needing to remember or change passwords.
			</p>

			<p style="margin-top:30px;">Best regards,<br/>Team Yuhuu</p>
		</div>
	`, otp)
